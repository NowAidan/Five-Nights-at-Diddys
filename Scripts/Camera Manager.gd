...
@onready var player_animations = $"../../../Player/AnimationPlayer"
#@onready var cam_flashlight_sound = $CamFlashlightSound


func _ready():
	$"../../../Player/Monitor/CameraMonitor".visible = false
...
func enable_camera_display():
	...
	player_animations.play("monitor_up")
...
func disable_camera_display():
	...
	selected_cam.current = false
	cam_ui.visible = false
	player_animations.play("monitor_down")
	await player_animations.animation_finished
